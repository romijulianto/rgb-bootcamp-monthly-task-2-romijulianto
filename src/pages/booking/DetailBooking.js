                ...
                <div className="container" id="mergeNavDetail">
                    <div className="container mb-3">
                        <div className="d-flex">
                            ...
                            <button className="btn mt-2"><b>Ringkasan Pesan</b></button>
                        </div>
                    </div>
                    <div className="container" id="detailNButton">
                        <div className="container" id="detailBooking">
                            <div className="container mt-3">
                                <div className="row align-items-start">
                                    ...
                                    <div className="col" id="labelBold">
                                        <b id="devider">: &nbsp;&nbsp;&nbsp;</b>Klinik Rolling Glory Beta Cisitu Indah IV  Dago, Bandung
                                    </div>
                                </div>
                                ...
                                <div className="row align-items-start mt-2">
                                    ...
                                    <div className="col" id="labelBold">
                                        <b id="devider">: &nbsp;&nbsp;&nbsp;</b>RT-PCR SARS-CoV-2 | Same Day
                                    </div>
                                </div>
                            ...
                            <div className="container">
                                <label className="container px-2"><b>Data Pasien</b></label>
                            ...
                            <div className="container mt-3 mb-4">
                                <label className="container px-2"><b>Jadwal Tes</b></label>
                                <div className="container" id="patientData">
                                    <div className="container mt-3">
                                        <div className="row align-items-start">
                                            <div className="container px-4" id="nameLabel">
                                            ...
                                            <div className="col" id="labelBold">
                                                <b id="devider">: &nbsp;&nbsp;&nbsp;</b>Senin, 28 Maret 2022
                                            </div>
                                        </div>
